...
| Overview | Overview layout gaps and zoom | `overviewgappi`, `overviewgappo` | WM policy | `overview { inner-gap-multiplier; outer-gap; zoom }` | X | Scroller layouts use Niri-style workspace previews; other layouts keep the Mango-style grid overview. |
