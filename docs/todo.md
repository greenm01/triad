...
- Janet follow-ups: persistent hook fibers, UI hook events, custom
  layout functions, additional prelude helpers as real scripts need them, and
  direct hook registration storage if synchronous hook files prove too limited.
