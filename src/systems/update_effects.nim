...
proc shouldBroadcastWindowsChanged*(kind: MsgKind): bool =
  ...
  of MsgKind.WlWindowCreated, MsgKind.WlWindowDestroyed, MsgKind.WlFocusChanged,
      ...
      MsgKind.CmdFocusWorkspaceIndex, MsgKind.CmdMoveToTagLeft,
...
proc shouldBroadcastTriadLayoutChanged*(kind: MsgKind): bool =
  ...
  of MsgKind.WlWindowCreated, MsgKind.WlWindowDestroyed, MsgKind.WlWindowDimensions,
      ...
      MsgKind.CmdSetColumnWidth, MsgKind.CmdFocusTag, MsgKind.CmdFocusWorkspaceIndex,
      MsgKind.CmdMoveToTag, MsgKind.CmdMoveToWorkspaceIndex, MsgKind.CmdMoveToTagLeft,
...
proc shouldCollapseAfterUpdate*(kind: MsgKind): bool =
  kind in {
    MsgKind.WlWindowDestroyed, MsgKind.CmdMoveToTag,
    MsgKind.CmdMoveWindowUpOrToWorkspaceUp, MsgKind.CmdMoveWindowDownOrToWorkspaceDown,
    MsgKind.CmdMoveToWorkspaceIndex, MsgKind.CmdMoveToScratchpad,
