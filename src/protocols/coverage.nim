...
const RiverProtocolCoverage* = [
  ...
  ProtocolCoverageEntry(event: "river_window_v1.dimensions", state: pcsLoggedIgnored, note: "Acknowledgement is logged; model geometry remains layout-driven."),
  ...
  ProtocolCoverageEntry(event: "river_window_v1.maximize_requested", state: pcsUnsupported, note: "No maximize implementation; capability is not advertised."),
  ProtocolCoverageEntry(event: "river_window_v1.unmaximize_requested", state: pcsUnsupported, note: "No maximize implementation; capability is not advertised."),
  ...
  ProtocolCoverageEntry(event: "river_window_v1.minimize_requested", state: pcsUnsupported, note: "No minimize implementation; capability is not advertised."),
  ...
  ProtocolCoverageEntry(event: "river_seat_v1.shell_surface_interaction", state: pcsLoggedIgnored, note: "Logged only; shell surface focus is not modeled."),
  ...
  ProtocolCoverageEntry(event: "river_layer_shell_seat_v1.focus_exclusive", state: pcsLoggedIgnored, note: "Logged only."),
  ProtocolCoverageEntry(event: "river_layer_shell_seat_v1.focus_non_exclusive", state: pcsLoggedIgnored, note: "Logged only."),
